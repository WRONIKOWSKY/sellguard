  ...
  return (
    ...
    >
      ...
      <div className="legal-content">
        ...
        <p>Le plan Découverte est proposé gratuitement et donne accès à un (1) certificat vidéo par mois ainsi qu'aux fonctionnalités d'analyse et de défense automatique.</p>
        <p>Le plan Pro est proposé au tarif de 49 euros par mois et donne accès à un nombre illimité de certificats vidéo, à la défense IA et à la génération d'annonce illimitée.</p>
        <p>Le plan Business est proposé au tarif de 99 euros par mois et donne accès à tout le plan Pro plus l'ancrage Bitcoin sur chaque preuve et un support dédié sous 4h.</p>
