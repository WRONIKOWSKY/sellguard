  ...
  return (
    ...
    >
      ...
      <div className="legal-content">
        ...
        <h2>Article 2. Modification des CGU</h2>
        ...
        <h2>Article 3. Création de compte et accès au Service</h2>
        ...
        <p>Le Service comprend deux fonctionnalités principales.</p>
        <p>La <strong>certification vidéo</strong> permet à l'utilisateur d'enregistrer une vidéo de l'article qu'il souhaite expédier ainsi que du processus d'emballage. Cette vidéo est transmise aux serveurs de SellCov, où elle est soumise à un traitement cryptographique produisant une empreinte numérique unique (hash SHA-256) associée à un horodatage certifié. L'empreinte est ensuite ancrée dans la blockchain Bitcoin via le protocole OpenTimestamps, garantissant que ni l'utilisateur ni SellCov ne peuvent modifier la date ou le contenu après coup. Un certificat est généré, permettant à l'utilisateur d'attester de l'état de l'article et du colis à la date et à l'heure d'enregistrement. Les vidéos certifiées sont archivées pendant une durée de cinq (5) ans à compter de leur création, durée correspondant au délai de prescription civile applicable aux litiges entre particuliers (article 2224 du Code civil), sous réserve de la suppression anticipée du compte dans les conditions prévues à l'article 9.</p>
        <p>La <strong>défense automatique par intelligence artificielle</strong> permet à l'utilisateur confronté à un litige de soumettre le message contestataire de l'acheteur ainsi que son certificat SellCov. Le Service génère alors automatiquement une réponse argumentée à destination du service de médiation de la plateforme de revente concernée. Cette réponse est fournie à titre d'aide à la rédaction ; l'utilisateur en demeure l'unique responsable et conserve toute latitude pour la modifier avant envoi.</p>

        <h2>Article 5. Valeur juridique des certificats</h2>
        ...
        <h2>Article 7. Tarifs et conditions financières</h2>
        ...
        <p>Le plan Découverte est proposé gratuitement et donne accès à un (1) certificat vidéo par mois ainsi qu'à la fonctionnalité de défense automatique.</p>
        <p>Le plan Pro est proposé au tarif de 49 euros par mois et donne accès à un nombre illimité de certificats vidéo, à la défense IA illimitée et à l'ancrage Bitcoin sur chaque preuve.</p>
        ...
        <p>Les données sont hébergées sur des serveurs situés au sein de l'Union européenne (région AWS eu-west-1, Irlande). Les vidéos font l'objet d'un chiffrement et ne sont accessibles qu'à l'utilisateur titulaire du compte. Elles ne sont en aucun cas transmises à des tiers sans le consentement explicite de l'utilisateur, sauf obligation légale ou décision de justice.</p>
        ...
        <h2>Article 13. Droit applicable et règlement des litiges</h2>
        ...
        <p>Pour toute question relative aux présentes Conditions Générales d'Utilisation, l'utilisateur peut contacter SellCov à l'adresse email suivante : <a href="mailto:hello@sellcov.com">hello@sellcov.com</a>.</p>
      </div>
    </LegalLayout>
  );
}
