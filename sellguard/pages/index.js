    ...
    <div class="demo-steps">
      ...
      <div class="demo-step">
        ...
        <div class="ui">
          ...
          <span class="ui-label" data-i18n="demo3_rlabel">Réponse générée</span>
...
<footer>
  <div class="foot">
    ...
    <div class="foot-links">
      ...
      <a href="#" data-i18n="ft_contact">Contact</a>
      <a href="#">Instagram</a>
      <a href="#">TikTok</a>
      <a href="/legal" data-i18n="ft_legal">Mentions légales</a>
...
const I18N = {
  fr:{
    ...
    demo3_title:"Défense automatique",demo3_buyer:"Acheteur",demo3_complaint:"« L'article est abîmé, je veux un remboursement »",demo3_rlabel:"Réponse générée",demo3_response:"« Preuve vidéo horodatée du 14/04 montre l'article en parfait état. Certificat SC-ABC123XYZ joint. »",demo3_btn:"Envoyer la défense",
  ...
  en:{
    ...
    demo3_title:"Automatic defence",demo3_buyer:"Buyer",demo3_complaint:"\"The item arrived damaged, I want a refund\"",demo3_rlabel:"Generated reply",demo3_response:"\"Timestamped video from 14/04 shows item in perfect condition. Certificate SC-ABC123XYZ attached.\"",demo3_btn:"Send defence",
  ...
  es:{
    ...
    demo3_title:"Defensa automática",demo3_buyer:"Comprador",demo3_complaint:"\"El artículo llegó dañado, quiero un reembolso\"",demo3_rlabel:"Respuesta generada",demo3_response:"\"Video del 14/04 muestra el artículo en perfecto estado. Certificado SC-ABC123XYZ adjunto.\"",demo3_btn:"Enviar defensa",
  ...
  de:{
    ...
    demo3_title:"Automatische Verteidigung",demo3_buyer:"Käufer",demo3_complaint:"\"Der Artikel ist beschädigt, ich möchte eine Rückerstattung\"",demo3_rlabel:"Generierte Antwort",demo3_response:"\"Video vom 14.04. zeigt Artikel in einwandfreiem Zustand. Zertifikat SC-ABC123XYZ beigefügt.\"",demo3_btn:"Verteidigung senden",
    ...
    <>
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .ui-cert{background:linear-gradient(135deg,rgba(94,232,163,.15),rgba(94,232,163,.03));border:1px solid rgba(94,232,163,.25);border-radius:10px;padding:12px;font-size:12px;color:var(--green);display:flex;align-items:center;gap:10px}
