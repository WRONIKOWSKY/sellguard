    ...
    <>
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .phone-island{position:absolute;left:28px;top:50%;transform:translateY(-50%);width:26px;height:110px;background:#000;border-radius:15px;z-index:4;box-shadow:inset 0 0 0 1px rgba(255,255,255,.06),0 0 6px rgba(0,0,0,.8);display:flex;align-items:center;justify-content:center}
        .phone-island-cam{width:7px;height:7px;border-radius:50%;background:radial-gradient(circle,#1a1a2e 30%,#000 70%);box-shadow:inset 0 0 2px rgba(80,100,200,.4),0 0 3px rgba(0,0,0,.8)}
        ...
        @media(max-width:820px){
          ...
          .phone-island{left:16px;width:18px;height:72px;border-radius:11px}
          .phone-island-cam{width:5px;height:5px}
